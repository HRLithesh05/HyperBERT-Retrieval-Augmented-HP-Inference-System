...
export default function ResultsDashboard() {
  ...
  const liveRadarData = liveData ? [
    { subject: 'HP Coverage', A: liveData.paper.reproducibility_score },
    { subject: 'Task Clarity', A: liveData.paper.task ? 90 : 10 },
    { subject: 'Model ID', A: liveData.paper.model ? 100 : 20 },
    { subject: 'Dataset Info', A: liveData.paper.dataset ? 80 : 5 },
    { subject: 'Reproducibility', A: liveData.completeness.completeness_pct },
  ] : radarData;
